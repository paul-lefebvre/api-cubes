  ...
  <div class="login">
    ...
    <div id="slideBox">
      <div class="topLayer">
        ...
        <div class="right">
          <div class="content">
            <h1>Links For Citizens</h1>
            <h2>Connexion</h2>
            <form @submit.prevent="submit">
              <div class="form-element form-stack">
                <label for="username-login" class="form-label">Email</label>
                <input v-model="data.email" id="username-login" type="text" name="username">
              </div>
              <div class="form-element form-stack">
                <label for="password-login" class="form-label">Mot de passe</label>
                <input v-model="data.password" id="password-login" type="password" name="password">
              </div>
              <div class="form-element form-submit">
                <button id="logIn" class="login" :class="{'disabled' : !validateFields}" type="submit" name="login">Se
                  Connecter
                </button>
