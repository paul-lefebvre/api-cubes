...
INSERT INTO lfc.ressources (RES_ID,USR_ID,CAT_ID,ANSWERS,IS_SIGNALED,NB_VIEWS,NB_LIKES,NB_SHARES,CREATED_AT) VALUES (2,2,2,'En quittant la vie des avangers j ai remonté le temps pour retrouver mon amour perdu. Nous avons eu beaucoup de temps à rattraper ensemble. Je ne regrette rien. Sauver le monde n est pas de tout repos...',0,21,32,10,'2022-02-12');
...
INSERT INTO lfc.ressources (RES_ID,USR_ID,CAT_ID,ANSWERS,IS_SIGNALED,NB_VIEWS,NB_LIKES,NB_SHARES,CREATED_AT) VALUES (7,7,3,'Tous les Gardiens de la Galaxie sont avec moi pour vous souhaiter un bon retour à la normal. Amusez-vous, retrouvez-vous tous ensemble pour profiter de la vie !!!',0,2,34,12,'2022-03-18');
INSERT INTO lfc.ressources (RES_ID,USR_ID,CAT_ID,ANSWERS,IS_SIGNALED,NB_VIEWS,NB_LIKES,NB_SHARES,CREATED_AT) VALUES (8,8,4,'Vous pensez bien que ce n est pas Natasha qui publie ce post. Ils ont fait un film sur elle et sa famille. Je ne connaissais pas sa sœur. Elle est aussi triste que moi. Nous partageons énormément de souvenirs...',0,2,34,12,'2022-02-18');
...
INSERT INTO lfc.users (USR_ID, PSEUDO, FIRSTNAME,LASTNAME,TEL,MAIL,PASSWORD,ROLES,STATUS,CREATED_AT,LAST_CON,RESET_CODE,BIRTH_DATE,GENDER,IS_ONLINE,ACTUAL_LAT,ACTUAL_LONG,BIO,AVATAR_IMG) VALUES (1,'IronMan','Morgan','Stark','0232356564','mstark@gmail.com','12345','Citoyen',1,'2022-03-21','2022-03-21','azerty','10-05-1990',1,1,123135,45646,'Adore les cheeseburgers','unknown.png');
